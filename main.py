...
rb1 = tk.Radiobutton(text="red", variable=var, value='red', font=myFont)
rb1.place(x=180, y=50)
# rb1.deselect()

rb2 = tk.Radiobutton(text="blue", variable=var, value='blue', font=myFont)
...
# Add button
button = tk.Button(text="Run Model", fg="black", bg="lightblue", width=10, height=1, font=myFont, command=select_item)
